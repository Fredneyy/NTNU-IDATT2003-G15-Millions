...
public class Share {
  ...
  public Share(Stock stock, BigDecimal quantity, BigDecimal pricePerShare) throws NullPointerException, IllegalArgumentException {
      Objects.requireNonNull(stock, "Stock cannot be null");
      isBigDecimalValuePositive("Quantity", quantity);
      isBigDecimalValuePositive("PurchasePrice", pricePerShare);
    this.stock = stock;
