...
public class StatsView {
  ...
  private VBox buildHoldingsCard() {
    ...
    holdingsTable.getColumns().add(symbolCol);
    holdingsTable.getColumns().add(qtyCol);
    holdingsTable.getColumns().add(avgBuyCol);
    holdingsTable.getColumns().add(currentCol);
    holdingsTable.getColumns().add(valueCol);
    holdingsTable.getColumns().add(plCol);
  ...
  public void setAvgTradeSize(String value) {
    avgTradeSize.setText(value);
  }

  public void setMostTraded(String value) {
    mostTraded.setText(value);
  }
  ...
  private static class KpiCard {
    ...
    KpiCard(String labelText, Ikon icon, Tone iconTone) {
      ...
      iconBox.getStyleClass().addAll("kpi-icon-box", "kpi-icon-box--"
          + iconTone.name().toLowerCase());
